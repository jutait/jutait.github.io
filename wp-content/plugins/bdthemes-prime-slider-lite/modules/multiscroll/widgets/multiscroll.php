	...
	protected function render_content_center() {
		...
		<div class="bdt-content-center">
			...
			foreach ( $settings['slides'] as $slide ) : ?>
				...
				<div <?php echo $this->get_render_attribute_string('ms_section_left'); ?> data-label="<?php echo $slide['title']; ?>" style="<?php echo esc_attr($left_bg); ?>">
					<div class="intro">
					...
					<?php if ( $settings['button_position'] == 'left' ) : ?>
						<?php if ($slide['slide_button'] && ( 'yes' == $settings['show_button'] )) : ?>
							<div <?php echo $this->get_render_attribute_string('button-position'); ?>>
			...
			foreach ( $settings['slides'] as $slide ) : ?>
				...
				<div <?php echo $this->get_render_attribute_string('ms_section_right'); ?> data-label="<?php echo $slide['title']; ?>" style="<?php echo esc_attr($right_bg); ?>">
					<div class="intro">
					<?php $this->rendar_item_content($slide); ?>
					<?php if ($slide['slide_image']['url']) : ?>
						<?php $this->rendar_item_image($slide); ?>
